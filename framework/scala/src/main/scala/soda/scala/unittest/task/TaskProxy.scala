...
](func: (A1, A2) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2]
    )
...
](func: (A1, A2, A3) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
...
class Task4[
  ...
  R: TypeTag
](func: (A1, A2, A3, A4) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
...
](func: (A1, A2, A3, A4, A5) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2], typeOf[A3], typeOf[A4],
      typeOf[A5]
...
](func: (A1, A2, A3, A4, A5, A6) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2], typeOf[A3], typeOf[A4],
      typeOf[A5], typeOf[A6]
...
](func: (A1, A2, A3, A4, A5, A6, A7) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2], typeOf[A3], typeOf[A4],
...
class Task8[
  ...
  R: TypeTag
](func: (A1, A2, A3, A4, A5, A6, A7, A8) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2], typeOf[A3], typeOf[A4],
...
](func: (A1, A2, A3, A4, A5, A6, A7, A8, A9) => R) extends _TaskBase[R] {
  override def execute(input: WorkInput): R = {
    val argTypes = List(
      typeOf[A1], typeOf[A2], typeOf[A3], typeOf[A4],
      typeOf[A5], typeOf[A6], typeOf[A7], typeOf[A8],
